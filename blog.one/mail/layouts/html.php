            ...
            <div class="col-md-8">
                <article class="post">
                    ...
                    <div class="post-content">
                        <header class="entry-header text-center text-uppercase">
                            ...
                            <h1 class="entry-title"><a href="blog.html">Content</a></h1>
                ...
                <article class="post">
                    ...
                    <div class="post-content">
                        ...
                        <div class="social-share">
                            <span class="social-share-title pull-left text-capitalize">By <a href="#">Rubel</a> 2019</span>
                            <ul class="text-center pull-right">
                                <li><a class="s-facebook" href="#"><i class="fa fa-eye"></i></a></li>325
                            </ul>
                        </div>
                ...
                <div class="primary-sidebar">
                    ...
                    <aside class="widget">
                        ...
                        <div class="popular-post">
                            ...
                            <div class="p-content">
                                <a href="#" class="text-uppercase">Content</a>
                                <span class="p-date">2019</span>
...
<footer class="footer-widget-section">
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2019 <a href="#"> </a> Built with <i
                            class="fa fa-heart"></i> by <a href="#"></a>
                    </div>
                </div>
            </div>
        </div>
